...
| [`archive/`](archive/) | Frozen, dated, one-off docs kept for provenance — **not** current truth (old launch checklists, reality-check audits, resume prompts, speculative drafts). See [`archive/README.md`](archive/README.md). |
