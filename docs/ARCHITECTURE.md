...
- Add a substrate-changing decision: draft a numbered ADR in
  `docs/adr/` (next free is ADR-0044, with ADR-0037 reserved for secure MCP ingress — ADR-0033 + ADR-0034 + ADR-0035 + ADR-0036 + ADR-0038 + ADR-0039 + ADR-0040 + ADR-0041 + ADR-0042 + ADR-0043 land;
