 ...
 * @property {import("./targets.mjs").HarnessTarget} target
 *                                         The harness-targets.mjs row.
 * @property {any} service                 The vaultProxyServices row.
 * @property {import("./targets.mjs").SkillDeclaration[]} skills
 ...
 *
 * @typedef {import("./targets.mjs").HarnessTarget} HarnessTarget
 */
