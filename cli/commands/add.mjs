...
import { resolveInput, buildLockfile } from "../lib/cluster/resolve-inputs.mjs";
 ...
 * of cli/commands/init.mjs); the surface is small enough that a
 ...
 * write cluster.lock.toml. Mirrors cli/lib/cluster/resolve-inputs.mjs
