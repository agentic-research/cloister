...
- **Architectural decisions** — [docs/adr/](docs/adr/) (25 numbered ADRs; 0001–0021 + 0023–0026, with 0022 reserved-but-not-drafted; start with 0001 → 0002 → 0007 → 0011 for the core mental model). Per-ADR status table in [`docs/STATUS.md`](docs/STATUS.md).
